...
$backupDisks = $backupDisks === [] ? ['backups'] : $backupDisks;
$notificationEmail = env('BACKUP_NOTIFICATION_MAIL_TO') ?: env('MAIL_FROM_ADDRESS', 'hello@example.com');
$failureNotificationChannels = env('BACKUP_NOTIFICATION_MAIL_TO') ? ['mail'] : [];
